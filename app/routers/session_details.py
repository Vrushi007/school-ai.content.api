...
async def create_session_details(session_details: SessionDetailsCreate, db: Session = Depends(get_db)):
...
async def update_session_details(session_details_id: int, session_details_update: SessionDetailsUpdate, db: Session = Depends(get_db)):
